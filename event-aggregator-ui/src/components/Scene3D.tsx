...
const BIG_SYMBOLS = [
    { t: "♫", x: -5.5, y:  2.4, z: -1.0, size: 2.2, op: 0.22, fs: 0.9, fi: 0.5, ri: 0.10 },
    { t: "♩", x:  5.2, y: -2.0, z: -1.5, size: 1.9, op: 0.20, fs: 0.8, fi: 0.6, ri: 0.08 },
    { t: "🎭", x:  5.8, y:  2.8, z: -2.5, size: 1.8, op: 0.28, fs: 0.7, fi: 0.4, ri: 0.06 },
    { t: "🎭", x: -5.0, y: -2.6, z: -2.0, size: 1.6, op: 0.25, fs: 0.6, fi: 0.5, ri: 0.05 },
    { t: "🎤", x: -1.5, y:  4.5, z: -2.0, size: 1.7, op: 0.26, fs: 0.8, fi: 0.5, ri: 0.07 },
    { t: "🎤", x:  2.0, y: -4.2, z: -2.5, size: 1.5, op: 0.22, fs: 0.7, fi: 0.6, ri: 0.06 },
];
