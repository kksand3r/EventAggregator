        ...
        <>
            ...
            >
                <div className="px-6 h-14 flex items-center justify-between gap-3 w-full">
                    ...
                    >
                        <div
                            className="w-8 h-8 rounded-xl bg-gradient-to-br from-[#7c4dff] to-[#b96cff] flex items-center justify-center shadow-[0_2px_8px_rgba(124,77,255,0.40)]">
              ...
              Event<span className="text-[#7c4dff]">Space</span>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {tab.count != null && tab.count > 0 && (
                                        <span
                                            className={`text-xs font-bold px-1.5 py-0.5 rounded-full leading-none ${active ? "bg-white/25 text-white" : "bg-[#7c4dff]/12 text-[#7c4dff]"}`}>
                    ...
                    <div className="flex md:hidden items-center gap-2 shrink-0">
                        <div
                            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#7c4dff]/10 rounded-full border border-[#7c4dff]/20 pointer-events-none select-none">
                        ...
                        >
                            <div className="relative w-4 h-3.5 flex flex-col justify-between overflow-hidden">
                                <span
                                    className={`block h-0.5 w-full bg-current rounded-full origin-left transition-all duration-300 ${isMenuOpen ? "rotate-45 translate-y-[0.5px]" : ""}`}/>
                                <span
                                    className={`block h-0.5 w-full bg-current rounded-full transition-all duration-300 ${isMenuOpen ? "opacity-0 -translate-x-2" : ""}`}/>
                                <span
                                    className={`block h-0.5 w-full bg-current rounded-full origin-left transition-all duration-300 ${isMenuOpen ? "-rotate-45" : ""}`}/>
                            </div>
                        </button>
                    </div>
                </div>
                ...
                <div
                    className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${isSearchOpen ? "max-h-20 opacity-100" : "max-h-0 opacity-0"}`}>
                ...
                <div
                  ...
                  <span className={`p-1.5 rounded-lg ${active ? "bg-white/20" : "bg-[#7c4dff]/10"}`}>
                    {tab.icon}
                                    ...
                                    {tab.count != null && tab.count > 0 && (
                                        <span
                                            className={`text-xs font-bold px-2 py-0.5 rounded-full ${active ? "bg-white/25 text-white" : "bg-[#7c4dff]/12 text-[#7c4dff]"}`}>
                      {tab.count > 999 ? `${Number((tab.count / 1000).toFixed(1))}k` : tab.count}
                    </span>
                                    )}
