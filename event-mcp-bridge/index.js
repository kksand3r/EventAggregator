...
Для формування посилання бери унікальний ідентифікатор події (з поля "id" або "_id" знайденого документа).
Формат посилання: [Назва події - Дата проведення](/events/ІДЕНТИФІКАТОР)
Приклад: "Я знайшов такі події: рекомендую відвідати [Рок-концерт СКАЙ - 29 Травня](/events/6f3a2b1c-4d5e) або [Симфонічний оркестр - 2 Червня](/events/9a8b7c6d-1e2f)."
        ` }]
            }
        ];
